...
class TestOrder:
    ...
    def test_order_constructor_ok(self):
    ...
    def test_order_constructor_on_incorrect_id(self):
    ...
    def test_order_constructor_on_incorrect_date(self):
    ...
    def test_order_constructor_on_incorrect_status(self):
    ...
    def test_order_constructor_on_incorrect_total_amount(self):
    ...
    def test_order_constructor_on_negative_total_amount(self):
    ...
    def test_order_constructor_on_incorrect_payment_method(self):
    ...
    def test_order_constructor_on_negative_nb_items(self):
