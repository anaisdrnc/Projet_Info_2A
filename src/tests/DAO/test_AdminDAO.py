...
class TestAdminDAO:
    ...
    def test_add_admin_ok(self, dao):
    ...
    def test_add_admin_duplicate(self, dao):
    ...
    def test_login_admin_ok(self, dao):
        """Test: An administrator can successfully log in with correct credentials."""
    ...
    def test_login_admin_wrong_password(self, dao):
    ...
    def test_login_admin_nonexistent_user(self, dao):
