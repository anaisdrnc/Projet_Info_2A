...
class TestDriverDAO:
    ...
    def test_create_driver_ok(self, dao):
    ...
    def test_create_driver_duplicate(self, dao):
    ...
    def test_list_all_drivers(self, dao):
    ...
    def test_update_driver_ok(self, dao):
    ...
    def test_update_driver_ko(self, dao):
    ...
    def test_login_driver_ok(self, dao):
    ...
    def test_login_driver_wrong_password(self, dao):
    ...
    def test_get_id_driver_by_id_user_ko(self, dao):
