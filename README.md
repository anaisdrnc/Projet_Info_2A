...
| `LICENSE` | defines the legal framework for using the project by specifying the rights, obligations, and limitations related to the reuse, modification, and distribution of the code. |
...
> **Create a API KEY GOOGLE MAPS**
- Go to the Google Maps Platform website and log in
- Go to the documentation part at the top of the page and select API Routes
