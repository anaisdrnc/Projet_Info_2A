...
def test_add_product_ok(dao):
    order = Order(id_customer=1, id_driver=1, delivery_address=create_test_address(), total_amount=0, payment_method="cash", nb_items=0)
    order_id = dao.create_order(order)
...
def test_cancel_order_ok(dao):
    order = Order(id_customer=1, id_driver=1, delivery_address=create_test_address(), total_amount=10, payment_method="cash", nb_items=1)
    order_id = dao.create_order(order)
...
def test_get_by_id_ok(dao):
    order = Order(id_customer=1, id_driver=1, delivery_address=create_test_address(), total_amount=15, payment_method="cash", nb_items=1)
    order_id = dao.create_order(order)
